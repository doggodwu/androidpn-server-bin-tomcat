...
<tr id="trUsername" style="display:none;">
	<td>Username:</td>
	<td><input type="text" id="username" name="username" value="a0fd882f9f6341cf98aada4ca3a78240" style="width:380px;" /></td>
</tr>
<tr>
	<td>Title:</td>
	<td><input type="text" id="title" name="title" value="测试消息" style="width:380px;" /></td>
</tr>
<tr>
	<td>Message:</td>
	<td><textarea id="message" name="message" style="width:380px; height:80px;" >测试消息，测试消息，测试消息！！</textarea></td>
</tr>
<%--
<tr>
	<td>Ticker:</td>
...
<tr>
	...
	<td><input type="text" id="uri" name="uri" value="" style="width:380px;" />
	    <br/><span style="font-size:0.8em">ex) http://www.baidu.com</span>
	</td>
</tr>
<tr>
	<td>&nbsp;</td>
